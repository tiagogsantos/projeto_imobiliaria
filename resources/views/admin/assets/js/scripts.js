$(function () {
    ...
    function normalizeSpouse() {
            ...
            // Se o campo estiver selecionado como Casado ou Separado o campo de conjuge será habilitado para preencher
            if($('select[name="civil_status"]').val() === 'married' || $('select[name="civil_status"]').val() === 'separated') {
                ...
                // Se o campo estiver como solteiro, divorciado ou viuvo o campo não será habilitado para preencher
        ...
        // Se o campo Civil Status for alterado para Casado eu vou poder preencher e salvar em seguida
