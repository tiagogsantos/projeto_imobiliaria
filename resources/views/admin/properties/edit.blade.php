...
<section class="dash_content_app">
    ...
    <div class="dash_content_app_box">
        ...
        <div class="nav">
            ...
            <form action="{{ route('admin.properties.update', ['properties' => $property->id]) }}" method="post" class="app_form" enctype="multipart/form-data">
                @csrf
                @method('put')
                            ...
                            <div class="property_image">
                                ...
                                <div class="property_image_item">
                                    ...
                                    <div class="property_image_actions">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-default btn-small {{ ($image->cover == true ? 'btn-green' : '') }} icon-check icon-notext image-set-cover"
    ...
    <script>
        $(function () {
            ...
            $('.image-set-cover').click(function(event) {
                ...
                // Disparando um post atraves do buton e action
                var button = $(this);
                $.post(button.data('action'), {}, function(response) {
                    // Se minha ação no botão for verdadeira eu irei setar o mesmo como verde, setando o mesmo removo da seleção da imagem anterior
