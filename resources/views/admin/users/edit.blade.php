...
<section class="dash_content_app">
    ...
    <div class="dash_content_app_box">
        <div class="nav">
            ...
            <!-- O código abaixo " $erros->all" significa que foi informado a mensagem de erro -->
                        ...
                        <div class="app_collapse">
                            ...
                            <div class="app_collapse_content d-none content_spouse">
                                ...
                                <label class="label">
                                    ...
                                    <select name="type_of_communion" class="select">
                        ...
                        <div class="app_collapse mt-2">
                            ...
                            <div class="app_collapse_content">
                                ...
                                <div class="companies_list">
                                    <!-- Quer dizer que consegui buscar as informas da empresa que esta no relacionamento com os users -->
                                    @if($user->companies()->get())
                                        ...
                                        @foreach($user->companies()->get() as $company)
                                            <div class="companies_list_item mb-2">
                                                ...
                                                <p><b>CEP:</b> {{ $company->zipcode }} <b>Bairro:</b> {{ $company->neighborhood }} <b>Cidade:</b> {{ $company->city }} / <b>Estado:</b>{{ $company->state }}</p>
                                            </div>
                                         @endforeach
                                    @else
