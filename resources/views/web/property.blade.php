        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <a class="btn btn-outline-success btn-lg btn-block icon-whatsapp mb-3"
                       href="https://api.whatsapp.com/send?phone=55+11+983683004&text=Olá, preciso de ajuda com o login.">Converse com o Corretor!
                    </a>

                    <div class="main_property_contact">
                        <h2 class="bg-front text-white text-center">Entre em contato</h2>
                        ...
                        <form action="{{ route('web.sendEmail') }}" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <p class="text-center text-front mb-0 mt-4 font-weight-bold">(11) 98368-3004</p>
                            </div>
                        </form>
                    </div>
