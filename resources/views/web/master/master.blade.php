...
<head>
    ...
    <link rel="stylesheet" href="{{ url(asset('frontend/assets/libs/css/ekko-lightbox.css')) }}">
        ...
        <div class="container">
            <div class="row py-1 d-flex justify-content-md-around">
                ...
                <div class="d-none d-lg-flex col-lg-4 justify-content-center align-items-center p-2 text-white">
                    ...
                    <p class="my-auto ml-3">Rua Eduardo de Capua<br/>São Paulo / SP</p>
                </div>
                ...
                <div class="d-flex col-12 col-md-6 col-lg-4 justify-content-center align-items-center p-2 text-white mx-auto">
                    ...
                    <p class="my-auto ml-3">tiagogoncalves044@gmail.com<br/>+55 (11) 98368-3004</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a href="{{ route('web.spotligth') }}" class="nav-link text-front">Destaque</a></li>
...
<div class="main_copyright py-3 bg-front text-white text-center">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="mb-0">Seger Imobiliária - São Paulo / SP</p>
                <p class="mb-0">Todos os Direitos Reservados - <a class="text-white" href="https://www.tiagogsantos.com"> Tiago Santos </a></p>
            </div>
        </div>
    </div>
</div>
