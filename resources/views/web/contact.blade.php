    ...
    <div class="container">
        ...
        <div class="row text-left">
            <form action="{{ route('web.sendEmail') }}" method="post">
                ...
                <div class="form-group">
                    <input type="tel" class="form-control" name="cell" placeholder="Insira seu telefone com DDD">
                </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-12 col-md-4">
                ...
                <p class="pt-2"><a href="mailto:tiagogoncalves044@gmail.com" class="text-front">tiagogoncalves044@gmail.com</a></p>
            </div>

            <div class="col-12 col-md-4">
                <h2 class="icon-phone">Por Telefone</h2>
                <p>Estamos disponíveis nos números abaixo no horário comercial.</p>
                <p class="pt-2 text-front">+55 (11) 98368-3004</p>
            </div>
