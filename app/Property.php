...
class Property extends Model
{
    ...
    {
        // Fazendo relacionamento de Property com usuário
        return $this->belongsTo(User::class, 'user', 'id');
    }

    public function images ()
    {
        // fazendo relacionamento com as imagens
    ...
    public function cover ()
    {
        ...
        // retornando a capa da imagem
        $cover = $images->where('cover', 1)->first(['path']);            
        

        // Se eu não achar a capa selecionada eu irei selecionar alguma pre estabelecida
        if(!$cover) {
            $images = $this->images();
    ...
    {
        // Se o checked for setado como preenchido o mesmo é on e consequentemente será salvo no banco como 1, assim está ativo
    ...
    /** Convertendo meu titulo para URL amigavel */
